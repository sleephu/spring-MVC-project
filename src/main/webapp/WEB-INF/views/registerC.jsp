...
<body class="pic">
  ...
  <li><a href="user/customer/"><span class="navSpan">Customer Login</span></a></li>
		</ul>
	</div>
	<h1 ></h1>
	<div class="n1">
 <!-- <p>
<a   class="a" href="user/customer/">Customer Login</a></p> -->
<!-- <p><a href="user/restaurant/index.jsp" target="myframe">Enterprise Login</a></p> -->
		
	</div>
	<div class="n2" id="text">
	<form:form class="inline" action="registerC" modelAttribute="user" method="post">
